...
CREATE TABLE IF NOT EXISTS `ds1_match` (
  ...
  INDEX `idx_match_fk_db_id` (`gc_dbsearch_id` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `meta_dbsearch` (
  ...
  `sch_lev2` VARCHAR(200) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `meta_match_template` (
  ...
  INDEX `idx_match_gc_usr_id` (`gc_usr_id` ASC),
  INDEX `idx_match_gc_probability` (`gc_probability` ASC),
  INDEX `idx_match_gc_dbsearch_db` (`gc_dbsearch_db` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `meta_dbsearch` (`id`, `sch_title`, `sch_table`, `sch_display`, `sch_lev1`, `sch_lev2`, `sch_lev3`, `sch_epsg`, `sch_lon`, `sch_lat`, `sch_like`, `sch_eq`, `sch_webservice`) VALUES (1, 'European cities > 500k', 'sch_geonames_eu500k', 'name', 'admin1 code', 'admin2 code', 'admin3 code', 4326, 'longitude', 'latitude', 'name;asciiname;alternatenames', NULL, 'ws-search-geonames');
...
INSERT INTO `meta_access` (`id`, `label`) VALUES (30, 'Viewer');
