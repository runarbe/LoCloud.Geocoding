...
<div id="topMenu" class="ui-widget-header ui-corner-all">
    ...
    <a id="btnDownloadRDF" class="topMenuBtn download" href="#" title="Download as Resource Descriptor Framework (RDF) format. Can be loaded into triple-stores etc.">*.rdf</a>
